...
def drives(METHOD, FB_IP, X_AUTH_TOKEN, API_VERSION, PARAMS, PAYLOAD, VALIDATE_SSL):
    ...
    result = send_request(FB_IP, ENDPOINT, METHOD, HEADERS, PARAMS, PAYLOAD, drives_validateparams, VALIDATE_METHODS, VALIDATE_SSL)
    return result

def drives_validateparams(METHOD, PARAMS):
